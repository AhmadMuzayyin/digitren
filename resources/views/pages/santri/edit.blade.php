                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col">
                                    <div class="mb-2">
                                        <x-input type='text' name='no_induk' id="no_induk" label='No Induk'
                                            placeholder='No Induk' attribute='readonly'
                                            value="{{ $item->no_induk }}"></x-input>
                                    </div>
                                </div>
                                <div class="col">
                                    <div>
                                        <x-input type="date" label='Tahun masuk' id="tahun_masuk" name='tahun_masuk'
                                            placeholder='Tahun masuk' value="{{ old('tahun_masuk') ?? $item->tahun_masuk }}"
                                ...
                                <div class="col">
                                    <div class="mb-2">
                                        <x-input type='text' name='nama_lengkap' id="nama_lengkap" label='Nama Lengkap'
                                            ...
                                            value="{{ old('nama_lengkap') ?? $item->user->name }}"
                                            attribute="required"></x-input>
                                    </div>
                                </div>
                                <div class="col">
                            ...
                            <div class="row mb-2" id="edit_alamat">
                                <div class="col">
                                    <div class="mb-2">
                                        <x-select-option name='provinsi_id' id="provinsi_id-{{ $item->id }}"
                                            label='Provinsi'>
                                        </x-select-option>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-2">
                                        <x-select-option name='kabupaten_id' id="kabupaten_id-{{ $item->id }}"
                                            label='Kabupaten'>
                                        </x-select-option>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-2">
                                        <x-select-option name='kecamatan_id' id="kecamatan_id-{{ $item->id }}"
                                            label='Kecamatan'>
                                        </x-select-option>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-2">
                                        <x-select-option name='kelurahan_id' id="kelurahan_id-{{ $item->id }}"
                                ...
                                <div class="col">
                                    <div class="mb-2">
                                        <x-input type='text' name='dusun' id="dusun" label='Dusun'
                                            placeholder='Dusun'
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                    <div class="mb-2">
                                        <x-input type='number' name='nik' id="nik" label='NIK'
                                            placeholder='NIK' value="{{ old('nik') ?? $item->nik }}"
                                            attribute="required"></x-input>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-2">
                                        <x-input type='number' name='kk' id="kk" label='KK'
                                            placeholder='KK' value="{{ old('kk') ?? $item->kk }}"
                                            attribute="required"></x-input>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-2">
                                        <x-input type='number' name='whatsapp' id="whatsapp"
                                            label='Nomor Whatsapp Aktif' placeholder='Nomor Whatsapp Aktif'
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col">
                                    <x-input type='text' label='Nama Ibu' id="nama_ibu" name='nama_ibu'
                            ...
                            <div class="row mb-2 mt-3">
                                ...
                                <div class="col">
                                    <div class="mb-2">
                                        ...
                                        <small class="text-muted" style="font-style: italic">Disabled jika sudah
                                            full</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col">
                                    <div class="mb-2">
                                        <x-input type="date" label='Tanggal Boyong' id="tanggal_boyong"
                                            name='tanggal_boyong' placeholder='Tanggal Boyong'
                                            value="{{ old('tanggal_boyong') ?? $item->tanggal_boyong }}"></x-input>
                                        <small class="text-muted" style="font-style: italic">Hanya jika sudah
                                            boyong</small>
                                    </div>
                                </div>
                            </div>
